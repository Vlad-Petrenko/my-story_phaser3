...
export default class PinkDressStrawBagGlassesScene extends Phaser.Scene {
  constructor() {
    super("PinkDressStrawBagGlassesScene");
  }
  ...
  create() {
    ...
    this.add.image(400, 500, "girl_pink_dress_straw_bag_glasses");
    ...
    function listener(pointer, gameObject) {
      if (gameObject.texture.key !== "btn_beach") {
        ...
        sceneStart(btnBeach, "PinkDressStrawBagGlassesBeachScene", globalThis);
      }
    }
  }
}
