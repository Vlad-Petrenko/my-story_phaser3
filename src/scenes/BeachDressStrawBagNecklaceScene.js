...
export default class BeachDressStrawBagNecklaceScene extends Phaser.Scene {
  constructor() {
    super("BeachDressStrawBagNecklaceScene");
  }
  ...
  create() {
    ...
    this.add.image(400, 500, "girl_beach_dress_straw_bag_necklace");
