...
export default class BeachDressBlueBagGlassesBalconyScene extends Phaser.Scene {
  constructor() {
    super("BeachDressBlueBagGlassesBalconyScene");
  }
  ...
  create() {
    ...
    const girl = this.add
      .image(-150, 500, "girl_beach_dress_blue_bag_glasses")
      .setScale(0.8);
