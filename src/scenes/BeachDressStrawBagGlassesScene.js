...
export default class BeachDressStrawBagGlassesScene extends Phaser.Scene {
  constructor() {
    super("BeachDressStrawBagGlassesScene");
  }
  ...
  create() {
    ...
    this.add.image(400, 500, "girl_beach_dress_straw_bag_glasses");
    ...
    function listener(pointer, gameObject) {
      if (gameObject.texture.key !== "btn_beach") {
        ...
        sceneStart(btnBeach, "BeachDressStrawBagGlassesBeachScene", globalThis);
      }
    }
  }
}
