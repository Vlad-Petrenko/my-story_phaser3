...
export default class PinkDressBlueBagGlassesScene extends Phaser.Scene {
  constructor() {
    super("PinkDressBlueBagGlassesScene");
  }
  ...
  create() {
    ...
    this.add.image(400, 500, "girl_pink_dress_blue_bag_glasses");
    ...
    function listener(pointer, gameObject) {
      if (gameObject.texture.key !== "btn_beach") {
        ...
        sceneStart(btnBeach, "PinkDressBlueBagGlassesBeachScene", globalThis);
      }
    }
  }
}
