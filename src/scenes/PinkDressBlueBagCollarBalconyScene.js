...
export default class PinkDressBlueBagCollarBalconyScene extends Phaser.Scene {
  constructor() {
    super("PinkDressBlueBagCollarBalconyScene");
  }
  ...
  create() {
    ...
    const girl = this.add
      .image(-150, 500, "girl_pink_dress_blue_bag_collar")
      .setScale(0.8);
