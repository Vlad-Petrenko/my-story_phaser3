...
export default class BeachDressBlueBagNecklaceBalconyScene extends Phaser.Scene {
  constructor() {
    super("BeachDressBlueBagNecklaceBalconyScene");
  }
  ...
  create() {
    ...
    const girl = this.add
      .image(-150, 500, "girl_beach_dress_blue_bag_necklace")
      .setScale(0.8);
