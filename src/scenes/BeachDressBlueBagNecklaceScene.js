...
export default class BeachDressBlueBagNecklaceScene extends Phaser.Scene {
  constructor() {
    super("BeachDressBlueBagNecklaceScene");
  }
  ...
  create() {
    ...
    this.add.image(400, 500, "girl_beach_dress_blue_bag_necklace");
    ...
    function listener(pointer, gameObject) {
      if (gameObject.texture.key !== "btn_beach") {
        ...
        sceneStart(btnBeach, "BeachDressBlueBagNecklaceBeachScene", globalThis);
      }
    }
  }
}
