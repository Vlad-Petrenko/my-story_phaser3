...
export default class PinkDressStrawBagCollarBalconyScene extends Phaser.Scene {
  constructor() {
    super("PinkDressStrawBagCollarBalconyScene");
  }
  ...
  create() {
    ...
    const girl = this.add
      .image(-150, 500, "girl_pink_dress_straw_bag_collar")
      .setScale(0.8);
