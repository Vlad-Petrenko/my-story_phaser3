...
export default class PinkDressBlueBagCollarScene extends Phaser.Scene {
  constructor() {
    super("PinkDressBlueBagCollarScene");
  }
  ...
  create() {
    ...
    this.add.image(400, 500, "girl_pink_dress_blue_bag_collar");
    ...
    function listener(pointer, gameObject) {
      if (gameObject.texture.key !== "btn_beach") {
        ...
        sceneStart(btnBeach, "PinkDressBlueBagCollarBeachScene", globalThis);
      }
    }
  }
}
