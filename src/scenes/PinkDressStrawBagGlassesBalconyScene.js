...
export default class PinkDressStrawBagGlassesBalconyScene extends Phaser.Scene {
  constructor() {
    super("PinkDressStrawBagGlassesBalconyScene");
  }
  ...
  create() {
    ...
    const girl = this.add
      .image(-150, 500, "girl_pink_dress_straw_bag_glasses")
      .setScale(0.8);
