...
export default class BeachDressStrawBagGlassesBalconyScene extends Phaser.Scene {
  constructor() {
    super("BeachDressStrawBagGlassesBalconyScene");
  }
  ...
  create() {
    ...
    const girl = this.add
      .image(-150, 500, "girl_beach_dress_straw_bag_glasses")
      .setScale(0.8);
